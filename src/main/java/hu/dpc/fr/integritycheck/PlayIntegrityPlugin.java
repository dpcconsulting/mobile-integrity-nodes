 ...
 * @since AM 5.5.0
 */
public class PlayIntegrityPlugin extends AbstractNodeAmPlugin {
	...
	protected Map<String, Iterable<? extends Class<? extends Node>>> getNodesByVersion() {
		return Collections.singletonMap(PlayIntegrityPlugin.currentVersion,
				Collections.singletonList(PlayIntegrity.class));
	}
	...
	public String getPluginVersion() {
		return PlayIntegrityPlugin.currentVersion;
	}
}
